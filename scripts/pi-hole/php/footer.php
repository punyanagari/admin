...
?>
	...
	<div class="pull-right hidden-xs hidden-sm<?php if(isset($core_commit) || isset($web_commit) || isset($FTL_commit)) { ?> hidden-md<?php } ?>">
            ...
            if($web_update){ ?> <a class="alert-link lookatme" href="https://github.com/arahasya/admin/releases" target="_blank">(Update available!)</a><?php } ?>
            <b>FTL Version </b> <?php
            echo $FTL_current;
      ...
      <div style="display: inline-block"><strong><a href="https://www.arahasya.com" target="_blank"><i class="fa fa-heart"></i> Arahasya </a></strong>by & Partronics</div>
    </footer>
</div>
<!-- ./wrapper -->
